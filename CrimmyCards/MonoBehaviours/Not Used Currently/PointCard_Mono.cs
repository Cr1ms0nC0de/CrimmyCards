...
//    public class StatEffect_Mono : Point_Mono
//    {
...
//            //CrimmyCards.instance.DebugLog($"[{CrimmyCards.ModInitials}][Debugging] Current number of points is {totalPointsEarned}");
//        }
